# Builds the logos-waku-ui library
...
pkgs.stdenv.mkDerivation {
  ...
  installPhase = ''
    ...
    if [ -f modules/waku_ui.dylib ]; then
      cp modules/waku_ui.dylib $out/lib/
    elif [ -f modules/waku_ui.so ]; then
      cp modules/waku_ui.so $out/lib/
    else
